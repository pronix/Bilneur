...
#     And I should see all claims

#   Scenario: Buy lot by Buy now
#     Given I am signed user
#     And I go to lot page
#     And I follow "Buy now"
#     And I checkour and paid
#     And auction ended automaticaly
#     And all member of auction get message about it
...
#     And I click "Agree"
#     Then all member of auction get a message about new claims
